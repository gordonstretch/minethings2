...
- all 13 gadget types and 42 activator items, additive original lifespans, the Hammer equipment-rate bonus, and ten-task round-robin Autoloader, Autolister, Automaker, and Automelder machinery
...
- six living route threats with physical movement, interception, same-tier treasure or tier-scaled Ore rewards; they can ambush compatible passing traffic or be deliberately hunted by any launch-ready transport of the matching combat class and route type at either endpoint, while defeated event creatures, destroyed player road vehicles, and open-route shipwrecks enter a one-shot, moon-adjusted remains scan that may raise proportional Wraith Riders and Ghost Ships; `/events` presents both in one spoiler-free industrial threat board with original grungy SVG art
...
- persistent Council service orders spanning exploration, mining, recycling, transport, markets, homes, Melds, factories, workers, Gadgets, and Oil Fields; rewards favour local Ore scraps and fractional Gold, never Credits, while 64 square-threshold reputation titles impose eight deliberately ugly public badges and rare administrative errors occasionally enclose a useful Thing
